...
public class NavigationViewGray extends RelativeLayout implements View.OnClickListener {

    public NavigationViewGray(Context context) {
        this(context, null);
    }
    ...
    // 从布局文件加载会调用
    public NavigationViewGray(Context context, AttributeSet attrs) {
        super(context, attrs);
        View view = LayoutInflater.from(context).inflate(R.layout.navigation_view_gray, this, true);
